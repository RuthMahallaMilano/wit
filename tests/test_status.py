...
from project.utils import get_all_files_in_directory_and_subs, get_all_files_in_repository_and_subs, get_staging_area
...
def test_status(test_folder):
    ...
    changes_to_be_committed, changes_not_staged_for_commit, untracked_files = status_function()
